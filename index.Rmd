...
```{r main-table}
DT::datatable(cbind(file = basename(all_files), import_df),
              filter = "top",          
              options = list(
                pageLength = 20,         
                autoWidth = TRUE,         
  ...
  DT::formatStyle(1L:ncol(import_df) + 1, 
                  backgroundColor = DT::styleEqual(levels = c("error", "something weird", "success"), 
